		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsapsfsfreshuffleapplicants-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapsfsfreshuffleapplicants-display": {
								"semanticObject": "comsapsfsfreshuffleapplicants",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.sfsf.reshuffle.applicants",
									"url": sap.ui.require.toUrl("com/sap/sfsf/reshuffle/applicants")
								}
							}
						}
					}
