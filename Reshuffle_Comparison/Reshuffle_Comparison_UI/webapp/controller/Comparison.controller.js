		...
		_getModelData: function (aSelectedCandidates) {
			...
			for (var key in aSelectedCandidates[0]) {
				if (aSelectedCandidates[0].hasOwnProperty(key) && key !== "caseId" && key !== "candidateID" && key !== "candidateName" && key !==
					"currentDivisionName" && key !== "currentDepartmentName" && key !== "currentPositionName" && key !== "nextDivisionName" && key !==
					"nextDepartmentName" && key !== "nextPositionName" && key !== "modifiedAt" && key !== "modifiedBy" && key !== "createdAt" && key !==
					"createdBy") {
					oProp = {};
					...
					for (var i = this._iFirstItem; i < this._iLastItem; i++) {
						...
						if (oCurrentCandidateInformation) {
							...
							if (key == "currentDivision") {
								oPropertyValue = {
									text: "<strong>" + aSelectedCandidates[i][key] + " : " + aSelectedCandidates[i]["currentDivisionName"] + "</strong>"
								};
							} else if (key == "currentDepartment") {
								oPropertyValue = {
									text: "<strong>" + aSelectedCandidates[i][key] + " : " + aSelectedCandidates[i]["currentDepartmentName"] + "</strong>"
								};
							} else if (key == "currentPosition") {
								oPropertyValue = {
									text: "<strong>" + aSelectedCandidates[i][key] + " : " + aSelectedCandidates[i]["currentPositionName"] + "</strong>"
								};
							} else if (key == "nextDivision") {
								oPropertyValue = {
									text: "<strong>" + aSelectedCandidates[i][key] + " : " + aSelectedCandidates[i]["nextDivisionName"] + "</strong>"
								};
							} else if (key == "nextDepartment") {
								oPropertyValue = {
									text: "<strong>" + aSelectedCandidates[i][key] + " : " + aSelectedCandidates[i]["nextDepartmentName"] + "</strong>"
								};
							} else if (key == "nextPosition") {
								oPropertyValue = {
									text: "<strong>" + aSelectedCandidates[i][key] + " : " + aSelectedCandidates[i]["nextPositionName"] + "</strong>"
								};
							} else {
								oPropertyValue = {
