sap.ui.define([
	...
	return BaseController.extend("com.sap.sfsf.comparison.Reshuffle_Comparison_UI.controller.Main", {
		...
		onSearch: function (oEvent) {
			...
			searchResult = this._searchDivision(searchResult, this._getSelectedItemText(this._getSelect("slDivision")), "C");
			searchResult = this._searchDepartment(searchResult, this._getSelectedItemText(this._getSelect("slDepartment")), "C");
			searchResult = this._searchPosition(searchResult, this._getSelectedItemText(this._getSelect("slPosition")), "C");
			searchResult = this._searchDivision(searchResult, this._getSelectedItemText(this._getSelect("slNextDivision")), "N");
			searchResult = this._searchDepartment(searchResult, this._getSelectedItemText(this._getSelect("slNextDepartment")), "N");
			searchResult = this._searchPosition(searchResult, this._getSelectedItemText(this._getSelect("slNextPosition")), "N");
